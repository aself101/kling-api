...
> Source: https://kling.ai/document-api/api/video/3-0-omni/text-to-video
> Locale: en
...
- `prompt`: The prompts can be templated to meet different video generation requirements.
- `prompt`: > **The Kling 3.0 model can achieve various capabilities through prompt and other content.**
  >
  > 
  ...
  >
  > 
  > 2. For more information, please refer to: [Kling VIDEO 3.0 Model User Guide](https://kling.ai/quickstart/klingai-video-3-model-user-guide).
